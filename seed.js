...
async function seedDatabase() {
  try {
    ...
    const preferencesData = [
      { title: "Travel", description: "Enjoys traveling", icon: "travel-icon", createdBy: newUser._id },
      { title: "Music", description: "Loves music", icon: "music-icon", createdBy: newUser._id },
      { title: "Food", description: "Food enthusiast", icon: "food-icon", createdBy: newUser._id }
    ];
